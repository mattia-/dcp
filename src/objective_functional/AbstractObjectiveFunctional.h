...
#ifndef SRC_OBJECTIVE_FUNCTIONAL_ABSTRACTOBJECTIVEFUNCTIONAL_HPP_INCLUDE_GUARD
#define SRC_OBJECTIVE_FUNCTIONAL_ABSTRACTOBJECTIVEFUNCTIONAL_HPP_INCLUDE_GUARD
