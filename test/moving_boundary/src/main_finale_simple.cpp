...
//    dolfin::DirichletBC dirBCwall (* (* (* navierStokesProblem.functionSpace())[0])[0], zero, meshFacets, 3, "geometric");
    dolfin::DirichletBC dirBCwall (* (* (* navierStokesProblem.functionSpace())[0])[0], zero, slipBoundary, "geometric");
dirBCwall.get_boundary_values(bdval);
    navierStokesProblem.addDirichletBC (dirBCwall, std::string("wall"));
/*    dolfin::DirichletBC dirBCcut (* (* (* navierStokesProblem.functionSpace())[0])[0], zero, meshFacets, 2, "geometric");
//    dolfin::DirichletBC dirBCcut (* (* (* navierStokesProblem.functionSpace())[0])[0], zero, fixedBoundary, "geometric");
dirBCwall.get_boundary_values(bdval);
  	navierStokesProblem.addDirichletBC (dirBCcut, std::string("cut"));*/
