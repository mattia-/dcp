...
#ifndef IVAN_DIFFERENTIALPROBLEM_LINEARDIFFERENTIALPROBLEM_HPP_INCLUDE_GUARD
#define IVAN_DIFFERENTIALPROBLEM_LINEARDIFFERENTIALPROBLEM_HPP_INCLUDE_GUARD
...
//#include "IvanAbstractDifferentialProblem.hpp"
#include <Factory/LinearSolverFactory.hpp>
#include <DifferentialProblem/SubdomainType.hpp>

namespace Ivan
{
  typedef dcp::AbstractDifferentialProblem AbstractDifferentialProblem;
}

namespace dcp
{
    /*! \class IvanLinearDifferentialProblem IvanLinearDifferentialProblem.hpp
    ...
    template <class T_BilinearForm_, class T_LinearForm_, class T_LinearSolverFactory_ = dcp::LinearSolverFactory>
        class IvanLinearDifferentialProblem : public Ivan::AbstractDifferentialProblem
        {
            // ---------------------------------------------------------------------------------------------//  
            ...
            public:
                ...
                IvanLinearDifferentialProblem () = delete;
                 ...
                 *  as input.
                 */
                IvanLinearDifferentialProblem (const std::shared_ptr<dolfin::Mesh> mesh, 
                 ...
                 *  as input.
                 */
                IvanLinearDifferentialProblem (const dolfin::Mesh& mesh, 
                 ...
                 *  as input.
                 */
                IvanLinearDifferentialProblem (dolfin::Mesh&& mesh, 
                 ...
                 *  destructible.
                 */
                virtual ~IvanLinearDifferentialProblem () {};
                 ...
                 */
                virtual dcp::IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>*
                    clone () const;
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
        IvanLinearDifferentialProblem (const std::shared_ptr<dolfin::Mesh> mesh, 
                                   const std::shared_ptr<dolfin::FunctionSpace> functionSpace,
                                   const std::string& solverType,
                                   const std::string& solverMethod,
                                   const std::string& solverPreconditioner) :
            Ivan::AbstractDifferentialProblem (mesh, functionSpace),
            ...
            rhsVector_ ()
        { 
            dolfin::begin (dolfin::DBG, "Building IvanLinearDifferentialProblem...");
            ...
            dolfin::log (dolfin::DBG, "IvanLinearDifferentialProblem object created");
        }
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        const T_BilinearForm& IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
        bilinearForm () const
        {
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        const T_LinearForm& IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
        linearForm () const
        {
            return linearForm_;
        }
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        const dolfin::Matrix& IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        const dolfin::Vector& IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
        rhs () const
        {
            return rhsVector_;
        }
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        void IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        bool IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        ...
        solve () 
        {
            ...
            // !!! MODIFICATO DA IVAN
/*//            std::shared_ptr<geometry::FunctionSpace<poisson::FunctionSpace, dolfin::ALE> > pMfs (&(*functionSpace_));
//            dolfin::Function tmpSol(pMfs,solution_.vector());
dolfin::File solutionFile("inside_solution.pvd");
solutionFile << solution_;
            geometry::FunctionSpace<poisson::FunctionSpace, dolfin::ALE>* pMfs (static_cast<geometry::FunctionSpace<poisson::FunctionSpace, dolfin::ALE>* > (&(*functionSpace_)));
            dolfin::Function tmpSol(std::shared_ptr<poisson::FunctionSpace>(new poisson::FunctionSpace(pMfs->mesh())),solution_.vector());
//            typename T_BilinearForm::TestSpace Spazio;
            geometry::FunctionSpace<typename T_BilinearForm::TestSpace, dolfin::ALE>* pMfsNew (static_cast<geometry::FunctionSpace<typename T_BilinearForm::TestSpace, dolfin::ALE>* > (&(*functionSpace_)));
            dolfin::Function tmpSolNew(std::shared_ptr<typename T_BilinearForm::TestSpace>(new (typename T_BilinearForm::TestSpace)(pMfsNew->mesh())),solution_.vector());
solutionFile << tmpSol;
tmpSolNew = solution_;
solutionFile << tmpSolNew;
//            solution_ = dolfin::Function(functionSpace_);
            solution_ = tmpSol;
            dolfin::plot(functionSpace_->mesh(),"inside - da function space");
            dolfin::interactive();
            dolfin::plot(solution_.function_space()->mesh(),"inside - da solution");
            dolfin::interactive();
//            dolfin::plot(static_cast<std::shared_ptr<const geometry::FunctionSpace<poisson::FunctionSpace,dolfin::ALE> > >(solution_.function_space())->mesh(),"inside - da solution");
    //        std::shared_ptr<geometry::FunctionSpace<poisson::FunctionSpace,dolfin::ALE> > tmpPtr(std::dynamic_cast<std::shared_ptr<geometry::FunctionSpace<poisson::FunctionSpace,dolfin::ALE> > >(functionSpace_));
    //        tmpPtr->meshMover();
    //        dolfin::plot(tmpPtr->mesh(),"inside - da solution");
    //        dolfin::interactive();
*/            
            dolfin::end ();
        }
    ...
    template <class T_BilinearForm, class T_LinearForm, class T_LinearSolverFactory>
        dcp::IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>*
        IvanLinearDifferentialProblem<T_BilinearForm, T_LinearForm, T_LinearSolverFactory>::
        clone () const
        {
            ...
            dolfin::log (dolfin::DBG, "Creating new object of type IvanLinearDifferentialProblem...");
            
            // create new object
            dcp::IvanLinearDifferentialProblem <T_BilinearForm, T_LinearForm, T_LinearSolverFactory>* clonedProblem = nullptr;
            if (cloneMethod == "shallow_clone")
            {
                clonedProblem = 
                    new dcp::IvanLinearDifferentialProblem <T_BilinearForm, T_LinearForm, T_LinearSolverFactory> 
                    (this->mesh_,
                     this->functionSpace_,
                     this->bilinearForm_, 
                     this->linearForm_,
