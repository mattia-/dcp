...
#ifndef IVAN_DIFFERENTIAL_PROBLEMS_NONLINEARPROBLEM_H_INCLUDE_GUARD
#define IVAN_DIFFERENTIAL_PROBLEMS_NONLINEARPROBLEM_H_INCLUDE_GUARD
...
namespace Ivan
{
     ...
     *  
     *  It inherits publicly from \c dcp::AbstractProblem
    ...
    template <class T_ResidualForm_, class T_JacobianForm_>
        class NonlinearProblem : public dcp::AbstractProblem
        {
            ...
            public:
                ...
                //! Set coefficient [1]. Override of virtual function in \c dcp::AbstractProblem.
                /*!
                 ...
                 *  See \c dcp::AbstractProblem documentation for more details on the function
                 */
                virtual void setCoefficient (const std::string& coefficientType, 
                                             const std::shared_ptr<const dolfin::GenericFunction> coefficientValue,
                                             const std::string& coefficientName = "default");

                //! Set coefficient [2]. Override of virtual function in \c dcp::AbstractProblem.
                /*!
                 *  Possible values for \c coefficientType are:
                 *  \li \c residual_form to set the coefficient in the residual form
                 *  \li \c jacobian_form to set the coefficient in the jacobian form
                ...
                //! Set integration subdomains for the forms. Override of virtual function in \c dcp::AbstractProblem
                /*! 
                ...
                //! Clone method. Overrides method in \c dcp::AbstractProblem
                /*!
                 ...
                 */
                virtual NonlinearProblem <T_ResidualForm, T_JacobianForm>*
                    clone () const;
...
solution_ = dolfin::Function(functionSpace_);
            ...
            {
if(mydebug==true){
dolfin::plot(functionSpace_->mesh(), "inside - functionSpace");
dolfin::interactive();}
                dolfin::Function mysol(functionSpace_);
if(mydebug==true){
dolfin::plot(mysol.function_space()->mesh(), "inside - mysol pre");
dolfin::interactive();
dolfin::plot(mysol[0].function_space()->mesh(), "inside - mysol pre - velocity");
dolfin::interactive();
std::cerr << " line : " << __LINE__ << std::endl;}
//                dolfin::solve (residualForm_ == 0, solution_, tmpDirichletBCs, jacobianForm_, 
                dolfin::solve (residualForm_ == 0, mysol, tmpDirichletBCs, jacobianForm_, 
                               parameters (solverParametersSetName));
if(mydebug==true){
dolfin::plot(mysol.function_space()->mesh(), "inside - mysol post");
dolfin::plot(mysol[0].function_space()->mesh(), "inside - mysol post - velocity");
dolfin::interactive();
std::cerr << " line : " << __LINE__ << std::endl;}
                solution_ = mysol;
if(mydebug==true){
dolfin::plot(solution_.function_space()->mesh(), "inside - solution");
dolfin::interactive();
dolfin::plot(solution_[0].function_space()->mesh(), "inside - solution - velocity");
dolfin::interactive();
std::cerr << " line : " << __LINE__ << std::endl;}
            }
            else
...
std::cerr << " line : " << __LINE__ << std::endl;
    ...
    template <class T_ResidualForm, class T_JacobianForm>
        ...
        clone () const
        {
            ...
            // create new object
            NonlinearProblem <T_ResidualForm, T_JacobianForm>* clonedProblem = nullptr;
            if (cloneMethod == "shallow_clone")
            {
                clonedProblem = 
                    new NonlinearProblem <T_ResidualForm, T_JacobianForm> 
                        ( this->mesh_,
                          this->functionSpace_,
                          this->residualForm_, 
                          this->jacobianForm_,
